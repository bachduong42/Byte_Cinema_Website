...
const Register = ({ setModalRef, openLoginModal, openConfirmOtpModal }) => {
  ...
  useGSAP(() => {
    ...
    tl.to(registerOverlayRef.current, { display: "flex" })
      .from(registerOverlayRef.current, {
        duration: 0.3,
        backgroundColor: "rgba(0,0,0,0)",
        ease: "expo.out",
      })
      .from(registerOuterBoxRef.current, {
        duration: 0.3,
        scaleY: 0,
        ease: "expo.out",
      })
...
const handleRegister = async (event) => {
  ...
  return (
    <>
      ...
      >
        <div
          id="register-outer-box"
          ref={registerOuterBoxRef}
                ...
                <div className="input mb-[1.5rem]">
                  <div className="relative flex-row">
                    ...
                    >
                      <IonIcon
                        icon={
                          isConfirmPasswordVisible ? eyeOutline : eyeOffOutline
                        }
                        className="text-[rgba(0,0,0,0.5)] text-2xl cursor-pointer"
                      />
                    </div>
